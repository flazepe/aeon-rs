...
pub static STEAM_COUNTRIES: Lazy<HashMap<&str, SteamCountry>> = Lazy::new(|| {
    HashMap::from([
        ...
        ("HK", SteamCountry { name: "Hong Kong", states: HashMap::new() }),
        ("TC", SteamCountry { name: "Turks & Caicos Islands", states: HashMap::new() }),
        (
            "NG",
            SteamCountry {
                name: "Nigeria",
        ...
        (
            ...
            SteamCountry {
                name: "Kiribati",
                states: HashMap::from([("03", "Phoenix Islands"), ("02", "Line Islands"), ("01", "Gilbert Islands")]),
            },
        ),
        (
            "SZ",
            SteamCountry {
                name: "Swaziland",
                states: HashMap::from([("05", "Praslin"), ("04", "Shiselweni"), ("03", "Manzini"), ("02", "Lubombo"), ("01", "Hhohho")]),
            },
        ),
        (
            "MS",
            SteamCountry {
                name: "Montserrat",
                states: HashMap::from([("03", "Saint Peter Parish"), ("02", "Saint Georges Parish"), ("01", "Saint Anthony Parish")]),
            },
        ),
        (
            "CI",
        ...
        ("PF", SteamCountry { name: "French Polynesia", states: HashMap::new() }),
        ("MH", SteamCountry { name: "Marshall Islands", states: HashMap::new() }),
        (
            "VE",
            SteamCountry {
                name: "Venezuela",
        ...
        ("FX", SteamCountry { name: "France, Metropolitan", states: HashMap::new() }),
        (
            "GA",
            SteamCountry {
                name: "Gabon",
        ...
        ("RE", SteamCountry { name: "Reunion", states: HashMap::new() }),
        (
            "LI",
            SteamCountry {
                name: "Liechtenstein",
        ...
        ("TO", SteamCountry { name: "Tonga", states: HashMap::from([("03", "Vava"), ("02", "Tongatapu"), ("01", "Ha")]) }),
        (
            "CU",
            SteamCountry {
                name: "Cuba",
        ...
        ("PR", SteamCountry { name: "Puerto Rico", states: HashMap::new() }),
        (
            "EC",
            SteamCountry {
                name: "Ecuador",
        ...
        ("MT", SteamCountry { name: "Malta", states: HashMap::new() }),
        (
            "PG",
            SteamCountry {
        ...
        ("BV", SteamCountry { name: "Bouvet Island", states: HashMap::new() }),
        (
            "GM",
            SteamCountry {
                name: "Gambia",
        ...
        (
            "LU",
            SteamCountry { name: "Luxembourg", states: HashMap::from([("03", "Luxembourg"), ("02", "Grevenmacher"), ("01", "Diekirch")]) },
        ),
        ("AW", SteamCountry { name: "Aruba", states: HashMap::new() }),
        (
            "IL",
            SteamCountry {
                name: "Israel",
        ...
        (
            ...
            SteamCountry {
                name: "Djibouti",
                states: HashMap::from([("05", "Tadjoura"), ("04", "Obock"), ("03", "Djibouti"), ("02", "Dikhil")]),
            },
        ),
        (
            "AL",
        ...
        ("TP", SteamCountry { name: "East Timor", states: HashMap::new() }),
        (
            "UG",
            SteamCountry {
                name: "Uganda",
        ...
        ("HM", SteamCountry { name: "Heard & McDonald Islands", states: HashMap::new() }),
        (
            "CV",
            SteamCountry {
                name: "Cape Verde",
        ...
        ("WF", SteamCountry { name: "Wallis & Futuna Islands", states: HashMap::new() }),
        (
            "MU",
            SteamCountry {
                name: "Mauritius",
        ...
        ("CK", SteamCountry { name: "Cook Iislands", states: HashMap::new() }),
        (
            "GY",
            SteamCountry {
                name: "Guyana",
        ...
        ("VG", SteamCountry { name: "British Virgin Islands", states: HashMap::new() }),
        (
            "US",
            SteamCountry {
                name: "United States",
        ...
        ("FO", SteamCountry { name: "Faroe Islands", states: HashMap::new() }),
        (
            "LK",
            SteamCountry {
                name: "Sri Lanka",
        ...
        ("NU", SteamCountry { name: "Niue", states: HashMap::new() }),
        (
            "DK",
            SteamCountry {
                name: "Denmark",
        ...
        (
            ...
            SteamCountry {
                name: "Kuwait",
                states: HashMap::from([("05", "Al Jahra"), ("03", "Hawalli"), ("02", "Al Kuwayt"), ("01", "Al Ahmadi")]),
            },
        ),
        (
            "AM",
        ...
        ("TF", SteamCountry { name: "French Southern Territories", states: HashMap::new() }),
        (
            "MV",
            SteamCountry {
                name: "Maldives",
        ...
        ("SG", SteamCountry { name: "Singapore", states: HashMap::new() }),
        (
            "CA",
            SteamCountry {
                name: "Canada",
        ...
        ("AN", SteamCountry { name: "Netherlands Antilles", states: HashMap::new() }),
        (
            "LA",
            SteamCountry {
                name: "Laos",
        ...
        ("CX", SteamCountry { name: "Christmas Island", states: HashMap::new() }),
        (
            "WS",
            SteamCountry {
                name: "Samoa",
        ...
        ("KM", SteamCountry { name: "Comoros", states: HashMap::from([("03", "Moheli"), ("02", "Grande Comore"), ("01", "Anjouan")]) }),
        (
            "TG",
            SteamCountry {
                name: "Togo",
        ...
        ("GP", SteamCountry { name: "Guadeloupe", states: HashMap::new() }),
        (
            "SH",
            SteamCountry {
                name: "St. Helena",
        ...
        ("VI", SteamCountry { name: "United States Virgin Islands", states: HashMap::new() }),
        (
            "GE",
            SteamCountry {
                name: "Georgia",
        ...
        ("IO", SteamCountry { name: "British Indian Ocean Territory", states: HashMap::new() }),
        (
            "ID",
            SteamCountry {
                name: "Indonesia",
        ...
        ("ZR", SteamCountry { name: "Zaire", states: HashMap::new() }),
        (
            "NL",
            SteamCountry {
                name: "Netherlands",
        ...
        ("ER", SteamCountry { name: "Eritrea", states: HashMap::new() }),
        (
            "CY",
            SteamCountry {
                name: "Cyprus",
        ...
        ("ST", SteamCountry { name: "Sao Tome & Principe", states: HashMap::from([("02", "Sao Tome"), ("01", "Principe")]) }),
        (
            "VU",
            SteamCountry {
                name: "Vanuatu",
        ...
        ("CC", SteamCountry { name: "Cocos (Keeling) Islands", states: HashMap::new() }),
        (
            "JO",
            SteamCountry {
                name: "Jordan",
        ...
        ("GF", SteamCountry { name: "French Guiana", states: HashMap::new() }),
        (
            "LY",
            SteamCountry {
        ...
        ("EH", SteamCountry { name: "Western Sahara", states: HashMap::new() }),
        (
            "MY",
            SteamCountry {
                name: "Malaysia",
        ...
        ("PW", SteamCountry { name: "Palau", states: HashMap::new() }),
        (
            "GR",
            SteamCountry {
                name: "Greece",
        ...
        ("SJ", SteamCountry { name: "Svalbard & Jan Mayen Islands", states: HashMap::new() }),
        (
            "PL",
            SteamCountry {
                name: "Poland",
        ...
        ("YT", SteamCountry { name: "Mayotte", states: HashMap::new() }),
        (
            "MN",
            SteamCountry {
                name: "Mongolia",
        ...
        ("MC", SteamCountry { name: "Monaco", states: HashMap::from([("03", "Monte-Carlo"), ("02", "Monaco"), ("01", "La Condamine")]) }),
        (
            "PA",
            SteamCountry {
                name: "Panama",
        ...
        ("AQ", SteamCountry { name: "Antarctica", states: HashMap::new() }),
        (
            "DO",
            SteamCountry {
        ...
        ("NC", SteamCountry { name: "New Caledonia", states: HashMap::new() }),
        ("YU", SteamCountry { name: "Yugoslavia", states: HashMap::new() }),
        ("PM", SteamCountry { name: "Saint Pierre and Miquelon", states: HashMap::new() }),
        ("MO", SteamCountry { name: "Macau", states: HashMap::from([("02", "Macau"), ("01", "Ilhas")]) }),
        (
            "SK",
            SteamCountry {
                name: "Slovakia",
        ...
        ("VA", SteamCountry { name: "Vatican City State (Holy See)", states: HashMap::new() }),
        (
            "BF",
            SteamCountry {
                name: "Burkina Faso",
        ...
        ("UM", SteamCountry { name: "United States Minor Outlying", states: HashMap::new() }),
        (
            "FI",
            SteamCountry {
                name: "Finland",
        ...
        ("TV", SteamCountry { name: "Tuvalu", states: HashMap::new() }),
        (
            "NO",
            SteamCountry {
                name: "Norway",
        ...
        ("TK", SteamCountry { name: "Tokelau", states: HashMap::new() }),
        (
            "PY",
            SteamCountry {
                name: "Paraguay",
        ...
        ("MP", SteamCountry { name: "Northern Mariana Islands", states: HashMap::new() }),
        (
            "CF",
            SteamCountry {
        ...
        (
            ...
            SteamCountry {
                name: "Sierra Leone",
                states: HashMap::from([("04", "Western Area"), ("03", "Southern"), ("02", "Northern"), ("01", "Eastern")]),
            },
        ),
        ("PN", SteamCountry { name: "Pitcairn", states: HashMap::new() }),
        ("GI", SteamCountry { name: "Gibraltar", states: HashMap::new() }),
        (
            "SA",
            SteamCountry {
                name: "Saudi Arabia",
        ...
        (
            ...
            SteamCountry {
                name: "Fiji",
                states: HashMap::from([("05", "Western"), ("04", "Rotuma"), ("03", "Northern"), ("02", "Eastern"), ("01", "Central")]),
            },
        ),
        ("AS", SteamCountry { name: "American Samoa", states: HashMap::new() }),
        (
            "TW",
            SteamCountry {
                name: "Taiwan",
                states: HashMap::from([("04", "T'ai-wan"), ("03", "T'ai-pei"), ("02", "Kao-hsiung"), ("01", "Fu-chien")]),
            },
        ),
        (
            "HT",
        ...
        ("GU", SteamCountry { name: "Guam", states: HashMap::new() }),
        (
            "SM",
            SteamCountry {
                name: "San Marino",
        ...
        ("MQ", SteamCountry { name: "Martinique", states: HashMap::new() }),
        (
            "CG",
            SteamCountry {
                name: "Congo",
        ...
        ("FK", SteamCountry { name: "Falkland Islands (Malvinas)", states: HashMap::new() }),
        (
            "ZW",
            SteamCountry {
                name: "Zimbabwe",
        ...
        ("AI", SteamCountry { name: "Anguilla", states: HashMap::new() }),
        (
            "HU",
            SteamCountry {
                name: "Hungary",
        ...
        (
            ...
            SteamCountry {
                name: "Turkmenistan",
                states: HashMap::from([("05", "Mary"), ("04", "Lebap"), ("03", "Dashoguz"), ("02", "Balkan"), ("01", "Ahal")]),
            },
        ),
        (
            "KH",
